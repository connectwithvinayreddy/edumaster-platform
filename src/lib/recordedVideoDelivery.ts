export type RecordedVideoDeliveryPath =
  | 'protected_hls_gateway'
  | 'direct_cloudflare_stream'
  | 'source_fallback'
  | 'unknown';

type RecordedVideoDeliveryInput = {
...
export const normalizeRecordedDeliveryPath = (value: unknown): RecordedVideoDeliveryPath | null => {
...
export const classifyRecordedVideoDeliveryPath = ({
  deliveryProfile,
  streamFormat,
  src,
  fallbackActive = false,
  drmEnabled = false,
}: RecordedVideoDeliveryInput): RecordedVideoDeliveryPath => {
